...
const checks=[
  ['package version is 0.6.0',()=>assert.equal(pkg.version,'0.6.0')],
  ...
  ['release label appears in UI',()=>assert.match(main,/v0\.6\.0 · YasReady UI Closure/)]
];
...
console.log(`PASS: ${passed}/${checks.length} v0.6 UI Closure checks`);
