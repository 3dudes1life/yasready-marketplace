...
const checks=[
  ['package version is 0.9.0',()=>assert.equal(pkg.version,'0.9.0')],
  ...
  ['release label appears in UI',()=>assert.match(main,/v0\.9\.0 · Marketing Studio/)]
];
...
console.log(`PASS: ${passed}/${checks.length} v0.9 UI Closure regression checks`);
