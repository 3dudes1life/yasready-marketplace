...
const checks=[
  ['package version is 0.7.0',()=>assert.equal(pkg.version,'0.7.0')],
  ...
  ['release label appears in UI',()=>assert.match(main,/v0\.7\.0 · Catalog Management/)]
];
...
console.log(`PASS: ${passed}/${checks.length} v0.7 UI Closure regression checks`);
