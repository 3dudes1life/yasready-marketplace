# Provider integration plan — v0.3.0
...
Live transfers are intentionally not executed in v0.3.0. Refund, dispute and transfer-reversal policy needs to be certified before money leaves the platform balance.
