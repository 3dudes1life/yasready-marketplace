...
const checks=[
  ['package version is 0.12.0',()=>assert.equal(pkg.version,'0.12.0')],
  ...
  ['release label appears in UI',()=>assert.match(main,/v0\.12\.0/)]
];
...
console.log(`PASS: ${passed}/${checks.length} v0.12 UI Closure regression checks`);
