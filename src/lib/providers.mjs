export const providerCapabilities=Object.freeze({
  ...
  ingram:{metadataFeed:true,inventoryFeed:true,ediFulfillment:true,shareAndSellFallback:true,salesReportingImport:true,providerDocuments:true,ipsExpressCheckout:true,ipsEligibilityRequired:true}
});
